...
import com.labella.store.order.web.rest.errors.BadRequestAlertException;
...
/**
 * REST controller for managing {@link com.labella.store.order.domain.LineItem}.
 */
@RestController
@RequestMapping("/api")
public class LineItemResource {
    ...
    private static final String ENTITY_NAME = "labellaStoreAppOrderLineItem";
