...
@RestController
@RequestMapping("/api/labella-store-app-order-kafka")
public class LabellaStoreAppOrderKafkaResource {
    private final Logger log = LoggerFactory.getLogger(LabellaStoreAppOrderKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public LabellaStoreAppOrderKafkaResource(KafkaProperties kafkaProperties) {
